...
**Hover-Deutsch** is a Firefox add-on that displays the definitions and translations of a German word simply by hovering over them, or by clicking. This information is retrieved from the PONS Dictionary API and displayed in a tooltip.
